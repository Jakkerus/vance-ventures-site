        ...
        <div className="container">
          <div className="privacy-card">
            <div className="privacy-section">
              ...
              <p>
                We may collect information you provide directly through our
                contact form, including your name, company, email address,
                subject, inquiry type, and message.
              </p>
              <p>
                We may also collect limited technical information such as IP
                address, browser type, and device data for security, fraud
                prevention, and site performance.
              </p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <p>
                ...
                business opportunities, improve the site experience, and protect
                the website from spam or abuse.
              </p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <p>
                This site may use cookies or similar technologies to improve
                site functionality, remember preferences, and support security
                features.
              </p>
            </div>
            ...
            <div className="privacy-section">
              ...
              <p>
                ...
                analytics, email delivery, and anti spam protection. These
                providers may process limited data as needed to support the
